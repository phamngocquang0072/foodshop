...
(function ($) {
    ...
    /* Rate Range Slider */
    var rangeSlider = $(".rate-range"),
        minrate = $("#minrate"),
        maxrate = $("#maxrate"),
        minRate = rangeSlider.data('min'),
        maxRate = rangeSlider.data('max');
    rangeSlider.slider({
        range: true,
        min: minRate,
        max: maxRate,
    ...
    minrate.val(rangeSlider.slider("values", 0)+'*');
    maxrate.val( rangeSlider.slider("values", 1)+'*');
